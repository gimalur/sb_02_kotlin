...
class ExampleUnitTest {
    ...
    */
    ...
    @Test
    fun login_user_by_csv() {
        val string = " John Doe ;JohnDoe@unknow.com;[B@7591083d:c6adb4becdc64e92857e1e2a0fd6af84;;"
        val holder = UserHolder
        val user = holder.importUsers(listOf(string)).first()
        val expectedInfo = """
            firstName: John
            lastName: Doe
